...
bot.on('message', function (message) {
	...
	let flags =
		args.groups?.flags === ''
			? undefined
			: args.groups?.flags.matchAll(/-(a|t|l|n|p|tr|pg|s|q|qa|atag|rtag|img|addalt|delalt|addseries|delseries|fav)\s+([^-]+)/g);

	if (flags && !args.groups?.flags.match(/^(?:-(a|t|l|n|p|tr|pg|q|s|qa|atag|rtag|img|addalt|delalt|addseries|delseries|fav)\s+([^-]+))+$/)) {
