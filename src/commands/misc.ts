...
async function stats(message: Message) {
	try {
		...
		const math = {
			...
			freq: freq,
			percentages: [
				Math.round((freq.S / len) * 10000) / 100,
				Math.round((freq['S-'] / len) * 10000) / 100,
				Math.round((freq['A+'] / len) * 10000) / 100,
				Math.round((freq.A / len) * 10000) / 100,
				Math.round((freq['A-'] / len) * 10000) / 100,
				Math.round((freq['B+'] / len) * 10000) / 100,
				Math.round((freq.B / len) * 10000) / 100,
				Math.round((freq['B-'] / len) * 10000) / 100,
				Math.round((freq['C+'] / len) * 10000) / 100,
				Math.round((freq.C / len) * 10000) / 100,
				Math.round((freq['C-'] / len) * 10000) / 100,
				Math.round((freq['D+'] / len) * 10000) / 100,
				Math.round((freq.D / len) * 10000) / 100,
				Math.round((freq['D-'] / len) * 10000) / 100,
			],
		};
